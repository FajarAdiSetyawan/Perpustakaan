<div class="card">
  <div class="container">
    <form action="laporan/laporan_buku.php" method="POST">
      <div class="row">
        <div class="col-25">
      ...
      <a href="./laporan/laporan_buku.php" class="btn btn-outline-info" target="blank" style="margin-top: 8px; margin-left: 5px;"> Cetak Semua</a>
    </form>
  </div>
</div>